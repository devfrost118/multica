...
// For Droid:       writes {workDir}/AGENTS.md  (Factory.ai droid CLI reads AGENTS.md natively)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "copilot", "opencode", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "antigravity", "droid":
...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	if len(ctx.AgentSkills) > 0 {
		...
		case "codex", "copilot", "opencode", "openclaw", "pi", "cursor", "kimi", "kiro", "antigravity", "droid":
			// Codex, Copilot, OpenCode, OpenClaw, Pi, Cursor, Kimi, Kiro,
			// Antigravity, and Droid discover skills natively from their
