...
- Своп демона: PID 10380 → PID 25108 (`--profile desktop-localhost-8080`), см. `daemon-swap.log` и `~/.multica/profiles/desktop-localhost-8080/daemon.log`. Живой демон — за 2 попытки не поднялся, восстановлен вручную. Грабли на будущее:
